...
echo "Setting routes to deny all traffic except https to Azure DevOps, ssh and squid ..."
run_cmd iptables -F OUTPUT
run_cmd iptables -A OUTPUT -j ACCEPT -p tcp --dport 443 -m iprange --dst-range 13.107.6.0-13.107.6.254
run_cmd iptables -A OUTPUT -j ACCEPT -p tcp --dport 443 -m iprange --dst-range 13.107.9.0-13.107.9.254
run_cmd iptables -A OUTPUT -j ACCEPT -p tcp --dport 443 -m iprange --dst-range 13.107.42.0-13.107.43.254
